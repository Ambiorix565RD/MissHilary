...
const Service = [
  ...
  {id:2, title: "Tutorías", img: "/img/studentSupport.jpg", category:"Tutorías", description: "¿Quieres que tus niños mejoren académicamente y alcancen un mayor nivel en sus habilidades educativas?\n\n¡El servicio de tutorías es ideal para ti!\n\nEste servicio consiste en acompañar a tu niño/a una o dos veces a la semana, presencialmente, con el objetivo de apoyarlo en la realización de sus actividades académicas. El enfoque se adapta a su estilo de aprendizaje y necesidades, para asegurar que alcance y obtenga el aprendizaje deseado en cada actividad y desarrolle habilidades que lo ayudarán a avanzar en su camino educativo."}, 
